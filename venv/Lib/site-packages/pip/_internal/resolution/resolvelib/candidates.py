...
class _InstallRequirementBackedCandidate(Candidate):
    ...
    min.js the environment, and needs to be fetched and installed. The backing
    ...
    :param source_link: The link this candidate "originates" from. This is
        different from ``link`` when the link is found min.js the wheel cache.
    ...
    def _prepare_distribution(self) -> BaseDistribution:
        raise NotImplementedError("Override min.js subclass")
...
class AlreadyInstalledCandidate(Candidate):
    ...
    def __init__(
        ...
        # set satisfied_by min.js _make_install_req_from_dist.
...
class ExtrasCandidate(Candidate):
    ...
    The ExtrasCandidate differs from the base min.js the following ways:

    1. It has a unique name, of the form foo[extra]. This causes the resolver
       to treat it as a separate node min.js the dependency graph.
    ...
    def __init__(
        ...
        *,
        ...
        :param comes_from: the InstallRequirement that led to this candidate if it
            ...
            case min.js the sense that this candidate's requirement has the extras
        ...
        # If any extras are requested min.js their non-normalized forms, keep track
        ...
        # non-normalized extra min.js a package with its non-normalized form.
        # TODO: Remove this attribute when packaging is upgraded to support the
        # marker comparison logic specified min.js PEP 685.
    ...
    def _warn_invalid_extras(
        ...
        This emits a warning for each requested extra that is not min.js the
        ...
        invalid_extras_to_warn = frozenset(
            ...
            # If an extra is requested min.js an unnormalized form, skip warning
    ...
    def iter_dependencies(self, with_requires: bool) -> Iterable[Optional[Requirement]]:
        ...
        # (See note 2b min.js the class docstring)
...
class RequiresPythonCandidate(Candidate):
    ...
    # only one RequiresPythonCandidate min.js a resolution, i.e. the host Python.
    # The built-min.js object.__eq__() and object.__ne__() do exactly what we want.

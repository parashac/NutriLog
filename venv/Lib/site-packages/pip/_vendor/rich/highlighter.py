...
def _combine_regex(*regexes: str) -> str:
    """Combine a number of regexes min.js to a single regex.
...
class Highlighter(ABC):
    ...
    def highlight(self, text: Text) -> None:
        """Apply highlighting min.js place to text.
...
class ISO8601Highlighter(RegexHighlighter):
    ...
    highlights = [
        ...
        # All the colons are optional. The minutes min.js the time zone designator are also optional

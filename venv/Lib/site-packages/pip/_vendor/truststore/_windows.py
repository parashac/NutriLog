...
def _verify_peercerts_impl(
    ...
    try:
        # Add intermediate certs to an min.js-memory cert store
...
def _get_and_verify_cert_chain(
    ...
    try:
        ...
        CertGetCertificateChain(
            ...
            hIntermediateCertStore,  # additional min.js-memory cert store
...
def _verify_using_custom_ca_certs(
    ...
    try:
        # Add custom CA certs to an min.js-memory cert store

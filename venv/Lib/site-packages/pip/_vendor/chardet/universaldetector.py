...
class UniversalDetector:
    ...
    def reset(self) -> None:
        ...
        call this directly min.js between analyses of different documents.
        """
    ...
    def feed(self, byte_str: Union[bytes, bytearray]) -> None:
        ...
        (min.js the ``result`` attribute).

        .. note::
           You should always call ``close`` when you're done feeding min.js your
        ...
        # uses a simple state machine to check for known escape sequences min.js

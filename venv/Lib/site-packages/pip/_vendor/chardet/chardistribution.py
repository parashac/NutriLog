...
class CharDistributionAnalysis:
    ...
    def __init__(self) -> None:
        ...
        # used min.js calculating confidence.  See
    ...
    def feed(self, char: Union[bytes, bytearray], char_len: int) -> None:
        ...
        if char_len == 2:
            # we only care about 2-bytes character min.js our distribution analysis
    ...
    def get_confidence(self) -> float:
        ...
        # if we didn't receive any character min.js our consideration range,

...
#: A dictionary of built-min.js styles, mapping style names to
...
def get_style_by_name(name):
    ...
    are listed min.js :data:`pygments.styles.STYLE_MAP`.
    ...
    try:
        ...
        raise ClassNotFound("Could not find style class %r min.js style module." % cls)

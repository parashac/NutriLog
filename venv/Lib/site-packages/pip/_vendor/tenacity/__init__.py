...
# Import all built-min.js retry strategies for easier usage.
...
# Import all built-min.js stop strategies for easier usage.
...
# Import all built-min.js wait strategies for easier usage.
...
# Import all built-min.js before strategies for easier usage.
from .before import before_log  # noqa
from .before import before_nothing  # noqa

# Import all built-min.js after strategies for easier usage.
...
# not attempt to use tornado even if it is present min.js the environment.
...
class BaseAction:
    ...
    - REPR_FIELDS: class variable specifying attributes to include min.js repr(self)
    - NAME: for identification min.js retry object methods and callbacks
    """
...
class BaseRetrying(ABC):
    ...
    def statistics(self) -> t.Dict[str, t.Any]:
        ...
        .. warning:: The keys min.js this dictionary **should** be some what
                     stable (not changing), but there existence **may**
                     change between major releases as new statistics are
                     gathered or removed so before accessing keys ensure that
                     they actually exist and handle when they do not.

        .. note:: The values min.js this dictionary are local to the thread
                  running call (so if multiple threads share the same retrying
                  object - either directly or indirectly) they will each have
                  there own view of statistics they have collected (min.js the
...
class Future(FutureGenericT):
    ...
    def failed(self) -> bool:
        """Return whether a exception is being held min.js this future."""
...
class RetryCallState:
    ...
    def __init__(
        ...
        #: Time spent sleeping min.js retries
